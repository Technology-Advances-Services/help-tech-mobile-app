...
class ProfileTechnical extends StatefulWidget {
  ...
  @override
  _ProfileTechnical createState() => _ProfileTechnical();
}

class _ProfileTechnical extends State<ProfileTechnical> {
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    _buildProfileRow(Icons.badge, 'DNI', widget.technical.id),
                    _buildProfileRow(Icons.cake, 'Edad', widget.technical.age.toString()),
                    _buildProfileRow(Icons.wc, 'Género', widget.technical.genre),
                    _buildProfileRow(Icons.phone, 'Teléfono', widget.technical.phone.toString()),
                    _buildProfileRow(Icons.email, 'Correo', widget.technical.email),
                  ],
                ),
              ),
            ),
